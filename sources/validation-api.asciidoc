...
* [tck-testable]#[methodname]`isInIterable()` returns `true` if the node represents an object contained in an array, [classname]`Iterable` or in a [classname]`Map`, `false` otherwise.#
