...
[NOTE]
.{spec-name-persistence} and Bean Validation
====
For maximum portability, persistent properties hosting Bean Validation constraints should use the same access strategy used in {spec-name-persistence}. In other words, place your Bean Validation constraint annotations on the same element (field or getter) as your {spec-name-persistence} annotations.
====
...
[source, JAVA, indent=0]
----
include::{validation-api-source-dir}javax/validation/groups/ConvertGroup.java[lines=7..8;24..-1]
----
====
...
[source, JAVA, indent=0]
----
include::{validation-api-source-dir}javax/validation/ParameterNameProvider.java[lines=13..-1]
----
====
...
[source, JAVA]
----
include::{validation-api-source-dir}javax/validation/TraversableResolver.java[lines=13..-1]
----
====
