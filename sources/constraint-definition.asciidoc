...
----
include::{validation-api-source-dir}javax/validation/Constraint.java[lines=29..-1]
----
...
[source, JAVA, indent=0]
----
include::{validation-api-source-dir}javax/validation/ConstraintTarget.java[lines=19..-1]
----
...
[source, JAVA, indent=0]
----
include::{validation-api-source-dir}javax/validation/ReportAsSingleViolation.java[lines=25..-1]
----
...
[source, JAVA, indent=0]
----
include::{validation-api-source-dir}javax/validation/OverridesAttribute.java[lines=26..-1]
----
...
[source, JAVA, indent=0]
----
include::{validation-api-source-dir}javax/validation/ConstraintValidator.java[lines=22..-1]
----
