...
`TypeParameter` contains the information about the type parameter. It is designed as a simplified and serializable version of `java.lang.reflect.TypeVariable`:

[source,java,indent=0]
----
include::{validation-api-source-dir}javax/validation/TypeParameter.java[lines=7..8;12..-1]
----
