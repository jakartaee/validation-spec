...
[source,java]
----
@Email(payload=Unwrapping.Unwrap.class) StringProperty emailProperty;
----
...
[source, JAVA, indent=0]
----
include::{validation-api-source-dir}javax/validation/valueextraction/UnwrapByDefault.java[lines=7..8;15..-1]
----
...
[source,java]
----
@NotNull(payload=Unwrapping.Skip.class) StringProperty emailProperty;
----
...
** Choose the most specific extractor matching the single type parameter found in step 2 which is marked with `UnwrapByDefault`
