...
+
__It doesn't seem right, but it may be useful when e.g. considering the case of `Tuple` above__.
...
1. Should we allow extractors to be defined for specific parameterizations of generic types, e.g.
+
[source,java]
----
