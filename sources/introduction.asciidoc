...
The following persons have actively contributed to {spec-name-bv} 2.0 as members of the JSR 380 expert group and the community at large in alphabetical order:
...
The following persons have actively contributed to {spec-name-bv} 1.1 as members of the JSR 349 expert group and the community at large in alphabetical order:
