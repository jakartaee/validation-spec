...
[source, JAVA, indent=0]
----
Unresolved directive in sources/builtin-constraints.asciidoc - include::../target/validation-api/javax/validation/constraints/NegativeOrZero.java[lines=7..8;26..-1]
----
...
[source, JAVA, indent=0]
----
Unresolved directive in sources/builtin-constraints.asciidoc - include::../target/validation-api/javax/validation/constraints/PositiveOrZero.java[lines=7..8;26..-1]
----
