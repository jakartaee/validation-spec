...
[tck-testable]#For applying constraints to the elements of generic container types or marking them for cascaded validation, the `container-element-type` element is used.#
